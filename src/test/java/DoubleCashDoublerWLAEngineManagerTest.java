...
public class DoubleCashDoublerWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DoubleCashDoublerWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DoubleCashDoublerIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DoubleCashDoublerIW/InitOutcome.xml").getDocumentElement();
